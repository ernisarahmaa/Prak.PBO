...
import tugas3.HitungBidang.Balok;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == bHitung) {
            ...
            try{
                ...
                lLuasP.setText      ("Luas Persegi                     : " + Double.toString(balok.L()));
                add(lLuasP);
                lLuasP.setBounds(30, 170, 300, 30);
                
                lKelilingP.setText  ("Keliling Persegi                 : " + Double.toString(balok.K()));
                add(lKelilingP);
                lKelilingP.setBounds(30, 210, 300, 30);
                
                lVolumeB.setText    ("Volume Balok                     : " + Double.toString(balok.V()));
                add(lVolumeB);
                lVolumeB.setBounds(30, 250, 300, 30);
                
                lLuasPer.setText    ("Luas Permukaan Balok           : " + Double.toString(balok.LP()));
                add(lLuasPer);
